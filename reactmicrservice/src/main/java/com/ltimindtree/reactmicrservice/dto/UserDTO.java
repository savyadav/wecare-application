package com.ltimindtree.reactmicrservice.dto;
...
public class UserDTO {
	...
	public String toString() {
		return "UserDTO [userId=" + userId + ", name=" + name + ", username=" + username + ", email=" + email
				...
				+ ", getUserId()=" + getUserId() + ", getName()=" + getName() + ", getUsername()=" + getUsername()
				+ ", getEmail()=" + getEmail() + ", getAddress()=" + getAddress() + ", getPhone()=" + getPhone()
				+ ", getWebsite()=" + getWebsite() + ", getCompany()=" + getCompany() + ", getClass()=" + getClass()
